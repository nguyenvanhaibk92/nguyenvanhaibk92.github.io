...
- [Table of Contents](#table-of-contents)
  ...
  - [Significant Results {#significant-results}](#significant-results-significant-results)
    - [Methodology {#methodology}](#methodology-methodology)
    - [Problem 1: 2D Heat Equation {#problem-1-2d-heat-equation}](#problem-1-2d-heat-equation-problem-1-2d-heat-equation)
    - [Problem 2: 2D Navier-Stokes Equations {#problem-2-2d-navier-stokes-equations}](#problem-2-2d-navier-stokes-equations-problem-2-2d-navier-stokes-equations)
    - [Training Cost and Speedup with Deep Learning Solutions {#training-cost-and-speedup-with-deep-learning-solutions}](#training-cost-and-speedup-with-deep-learning-solutions-training-cost-and-speedup-with-deep-learning-solutions)
    - [Paper publication {#paper-publication}](#paper-publication-paper-publication)
...
#### Problem 1: 2D Heat Equation {#problem-1-2d-heat-equation}
...
<figcaption align="justify" style="margin-top: 2px;"><b>Figure 2: 2D heat equation.</b> <b>Left:</b> A sample of the PoI (the heat conductivity field). <b>Right:</b> The corresponding state (temperature field), observations (temperatures) are taken at 10 observed points. This pair of PoI and observation sample is used for training in one training sample case. The middle and right figures show the conductivity coefficient fields \(u\) and its corresponding temperature field \(\mathbf{y}_{\text{full}}\) for the first pair out of 100 training sample pairs. This particular pair serves as the training data for the single-sample training case for all approaches.</figcaption>
...
**Generating train and test data sets.** {#generating-train-and-test-data-sets}
...
**Learned inverse and PtO/forward maps accuracy.** {#learned-inverse-and-ptoforward-maps-accuracy}
...
**TAENfull robustness to a wide range of noise levels.** {#taenfull-robustness-to-a-wide-range-of-noise-levels}
...
**TAENfull robustness to arbitrary single-sample.** {#taenfull-robustness-to-arbitrary-single-sample}
...
#### Problem 2: 2D Navier-Stokes Equations {#problem-2-2d-navier-stokes-equations}
...
**Generating train and test data sets.** {#generating-train-and-test-data-sets-1}
...
**Learned inverse and PtO/forward maps accuracy.** {#learned-inverse-and-ptoforward-maps-accuracy-1}
...
**TAENfull robustness to a wide range of noise levels.** {#taenfull-robustness-to-a-wide-range-of-noise-levels-1}
...
**TAENfull robustness to arbitrary single-sample.** {#taenfull-robustness-to-arbitrary-single-sample-1}
...
#### Training Cost and Speedup with Deep Learning Solutions {#training-cost-and-speedup-with-deep-learning-solutions}
